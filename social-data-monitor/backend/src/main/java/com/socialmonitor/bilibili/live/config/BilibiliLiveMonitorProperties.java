package com.socialmonitor.bilibili.live.config;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.stereotype.Component;

@Component
@ConfigurationProperties(prefix = "app.bilibili.live-monitor")
public class BilibiliLiveMonitorProperties {

    private boolean enabled = true;
    private boolean storageEnabled = true;
    private int schedulerDelayMs = 1000;
    private int dueBatchSize = 20;
    private int statusBatchSize = 30;
    private int defaultIntervalSeconds = 300;
    private int minIntervalSeconds = 1;
    private int maxIntervalSeconds = 2_592_000;
    private int shortIntervalWarningSeconds = 120;
    ...
    private String userAgent = "SocialDataMonitor/0.1 (+low-frequency public Bilibili live monitor)";
    private String referer = "https://live.bilibili.com/";
    ...
    public void setStatusBatchSize(int statusBatchSize) {
